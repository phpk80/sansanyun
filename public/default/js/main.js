...
function addCart(gid, direct, num, spec) {
	...
	$.getJSON("/api.php/cart/addcart", data, function(res) {
...
$(function() {
	...
	function show_cartinfo(t) {
		$.getJSON("/api.php/cart/get_cart", {act: 'get_cart'}, function(res) {
			if(res.err && res.err != '') {
				...
				$(".slidecart-js").attr("href", res.data.num >0 ?"/cart/index":"javascript:void(0);")
...
function check_mobile(mobile, callback) {
	...
	$.getJSON("/api.php/user/check_mobile", {mobile:mobile}, function(res){
